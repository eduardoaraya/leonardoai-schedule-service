...
export interface IScheduleRepository {
  query: (request: IScheduleQueryRequest, select?: IScheduleSelect) => Promise<IScheduleResult[]>;
  create: (request: IScheduleCreateRequest, select?: IScheduleSelect) => Promise<IScheduleBase>;
  update: (scheduleId: string, request: IScheduleUpdateRequest, select?: IScheduleSelect) => Promise<IScheduleBase>;
...
export interface IScheduleService {
  ...
  create: (account: IUserBase, agent: IUserBase, request: Pick<IScheduleCreateRequest, "startTime" | "endTime">) => Promise<IScheduleResult>;
  update: (scheduleId: string, account: IUserBase, agent: IUserBase, request: IScheduleUpdateRequest) => Promise<IScheduleResult>;
  delete: (scheduleId: string) => Promise<boolean>;
  getById: (scheduleId: string) => Promise<IScheduleResult|null>;
  hasConflictingAppointments: (user: IUserBase, startTime: Date | string, endTime: Date | string) => Promise<boolean>;
}
export interface IScheduleController {
  filter: (req: Request<IScheduleQueryRequest>, res: Response) => Promise<Response>;
...
export interface IScheduleUpdateRequest extends Prisma.ScheduleUncheckedUpdateInput { }
